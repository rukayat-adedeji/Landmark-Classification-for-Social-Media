...
from .helpers import compute_mean_and_std, get_data_location, compute_mean_and_std_concurrent
...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([T.RandomAffine(translate =(0.1,0.1), degrees=0,  interpolation = T.InterpolationMode.BILINEAR ),
